...
class TabInterface(QWidget):
    ...
    def __init__(self, parent, main_logic, root, tab_num):
        ...
        pscan_plot_layout1.addWidget(self.canvas_enc, 0, 0, Qt.AlignCenter)
        pscan_plot_layout1.addWidget(self.toolbar_enc, 1, 0, Qt.AlignCenter)

        right_layout.addWidget(pscan_plot_group1, 2, 0, Qt.AlignCenter)

        extra_widget = QWidget()
        extra_widget.setStyleSheet("background-color: lavender; border: none;")
        extra_widget.setFixedWidth(500)
